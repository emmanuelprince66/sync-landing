const Terms = () => {
  return (
    <div className="w-[80%] mx-auto my-[1%]">
      <p className="text-5xl text-center text-[#000]">Terms and Conditions</p>
      <p className="text-3xl text-center text-[#000] my-5">
      ...
      <div className="w-full items-start flex-col flex mt-[4%]">
        ...
        <p className="leading-6 text-1xl ">
          ...
          agree to our Privacy and Cookie Policy in full and without limitation
          or qualification.
        </p>
        <p className="leading-6 text-1xl  mt-[2%]">
          These Terms also highlight certain risks on using our services and you
          must consider such risks carefully as you will be bound by the
          provision of this Agreement through your use of our services. We
          therefore oblige you to thoroughly read these Terms carefully before
          agreeing to be bound by them. You must not use any of the Services if
        ...
        <p className="leading-6 text-1xl ">
          By signing on to use our Services, you are warranting that you are not
          a person barred from receiving services under the laws of the Federal
          Republic of Nigeria. If you are accepting these Terms and using the
          Services on behalf of a business or organization, you represent and
          warrant that you are authorized to do so.
          <br />
          <br /> Our Services are available only to people aged 18 or over.
          Individuals under the age of 18, may utilize the service only with the
          involvement of a parent or legal guardian, under such person’s account
          and subject to these Terms. The User must have the contractual
          capacity to enter a binding contract with us and must not be barred
          from doing so under any applicable laws. You also warrant that any
          registration information that you submit to us is true, accurate and
          complete. You shall indemnify us against any losses we incur in
          connection with your breach of this section.
        </p>
        ...
        <ul className="mt-[3%] leading-6">
          ...
          <li>(c) Accept the terms and conditions contained herein; </li>
          <li>
        ...
        <p className="leading-6 text-1xl mt-[2%]">
          ...
          yourself as prompted during the account registration process. Upon
          registration, you will receive a generic Personal{" "}
          <span className="font-bold">Identification Number (PIN)</span> as a
          vendor as a user you will be prompted to create an Pin and will be
          prompted to change or create a unique PIN to secure your account. You
          are responsible for keeping your PIN secure. Your personal information
          is highly protected. Our services will be available to you only after
          you comply with our KYC (Know Your Customer) process and your
          identification has been verified
        </p>
        <p className="text-2xl my-[4%] ">5.0. Onboarding Requirements (KYC)</p>
        <p className="leading-6 text-1xl ">
          To meet our Know Your Customer (“KYC”) and Anti-Money Laundering
          (“AML”) obligations, we may require you to provide any or all the
          following: <br />
          (a) Your full name (as it appears on your government issued ID) (b)
          Your date of birth, your Bank Verification Number (“BVN”);
          <br /> (c) Your current residential address; your picture (c) Your
          current residential address; your picture
          <br /> (d) Copy of a valid Government issued ID (national ID,
          international passport, permanent voter’s card or driver’s license); a
          copy of recent utility bill, dated within three months of our request,
          which carries your name and address;
          <br /> (e) Any other information or document as we may require for our
          ...
          request for further information from you pertaining to your use of the
          Services at any time. Failure to provide such information within the
          time required may result in Us declining to accept your application
          for an Account or access to our Services.
          <br />
          <br />{" "}
          ...
          your category. Should you attempt to exceed any applicable limits,
          your transactions will be declined.
        </p>
        <p className="text-2xl my-[4%] ">6.0 Transacting on your Account</p>
        <p className="leading-6 text-1xl ">
          Upon creating your account, a Bank Account Number will be assigned to
          ...
          - Your instructions are unclear. <br />
          - We suspect criminal, fraudulent, or illegal activity. <br />
          - The transaction exceeds account limits. <br />
          - Your account is dormant.
          <br />- Insufficient funds are in your account. <br />
          - Regulations or laws prohibit or restrict it. <br />
          <br />
          You may need to set a password/PIN for transactions. When you confirm
          a transaction with your password, it is considered authorized. You are
          responsible for maintaining the confidentiality of your PIN and login
          details and preventing their fraudulent use.
        </p>
        <p className="text-2xl my-[4%] ">7.0 Notifications.</p>
        <p className="leading-6 text-1xl ">
          By opening an account with us, you consent to receiving SMS, email,
        ...
        <p className="leading-6 text-1xl ">
          ...
          related mobile application for violating any of our prohibited uses or
          for actions we consider unlawful or unethical.
        </p>
        ...
        <p className="leading-6 text-1xl ">
          ...
          agree to reporting to NIBSS and the CBN's Watchlist Database if
          fraudulent activity is associated with your account.
        </p>
        ...
        <p className="text-2xl my-[4%] ">11. Marketing and Promotion</p>
        <p className="leading-6 text-1xl ">
        ...
        <p className="leading-6 text-1xl ">
          ...
          corruption Laws in Nigeria (including the Economic and Financial Crime
          Commission’s Act).
        </p>
        ...
        <p className="text-2xl my-[4%] ">14.0. Applicable Law</p>
        <p className="leading-6 text-1xl ">
          These Terms & Conditions shall be interpreted and governed by the
          current laws in the Federal Republic of Nigeria.
        </p>
        ...
        <p className="leading-6 text-1xl ">
          We use the True Depth API within the camera module to record a video
          of the user for a liveness check during our Know Your Customer (KYC)
          ...
          live.
          <br />
          <br /> The video is shared with a third party service solely to verify
          the user's identity, after which it is deleted as required under
          applicable laws and regulations.
          <br />
          <br /> The third party service is obligated to protect the user's data
          in accordance with data protection laws and is not allowed to use this
          data for any form of marketing or venture outside its agreement with
          us.
          <br />
          <br /> The user can opt out of the video capture process at any time.
          <br />
          <br />
          Information you give us when you contact us through other channels If
          you contact us via other means than the in-app chat, we collect the
          following information so we can answer your questions or take action.
          <br />
          <br />
          The phone number you’re calling from and information you give us
          during the call The email address you use and the contents of your
          email (and any attachments) sent to us.
          <br />
          ...
          verify the authenticity and validity of the identification document
          that you have provided, either directly from the issuing authorities
          or through authorized service providers. Also, when you request for
          credit or lending related products and services, we run further checks
          with the licensed credit bureaus for eligibility checks in line with
          regulations.
        </p>
        <p className="text-2xl my-[4%] ">How do we use your information?</p>
        <p className="leading-6 text-1xl ">
          The Nigerian Data Protection Regulations 2019 (NDPR) requires that we
          have a lawful basis for processing your personal information. At least
          one of the following lawful basis must apply before we process your
          personal information: contractual or legal obligations, legitimate
          interest of the data controller, public interest, vital interest of
          the data subject or consent. <br />
          <br />
          Contractual Obligation <br />
          <br />
          We collect certain data from you to fulfill the contract we have with
          you, or to enter into a contract with you. We use this data to: <br />
          <br /> Give you the services we agreed to in line with our terms and
          conditions. <br />
          <br />
          Send you messages about your account and other services you use if you
          get in touch, or we need to tell you about something.. <br />
          <br />
          Exercise our rights under contracts we’ve entered into with you, like
          managing, collecting and recovering money you owe us. <br />
          <br /> Investigate and resolve complaints and other issues. Legal Duty
          ...
          financing and fraud. To do this, we need your data to; Confirm your
          identity when you sign up or get in touch. <br />
          <br /> Prevent illegal activities like money laundering, tax evasion
          and fraud. <br />
          <br />
          Keep records of information we hold about you in line with legal
          requirements. <br />
          <br />
          Adhere to banking laws and regulations (these mean we sometimes need
      ...
      <p className="leading-6 text-1xl ">
        ...
        legitimate interests. This means we’re using your data in a way that you
        might expect us to, for a reason which is in your interest and doesn't
        override your privacy, interests or fundamental rights and freedoms.
        <br />
        <br />
        Consent For certain information, we’ll ask for your consent. We’ll ask
        for your consent to: <br /> <br />
        Market and communicate our products and services. You can always
        unsubscribe from receiving these if you want to; <br /> <br /> Help
        protect you against fraud by tracking the location of your phone if
        you’ve authorized it; View your contact list for airtime purchases.
      </p>
      <p className="text-2xl my-[4%] ">
        Who do we share your information with?
      </p>
      <p className="leading-6 text-1xl ">
        In some instances, we will share the information provided with some
        third parties that we do business with, like card producers and credit
        bureaus, or with law enforcement agencies when required. Sharing of
        confidential customer information with these related third parties would
      ...
      <p className="text-2xl my-[4%] ">When do we delete your data?</p>
      <p className="leading-6 text-1xl ">
        We are basically storing and processing your personal data only as long
