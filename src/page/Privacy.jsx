  ...
  return (
    <>
      <div className="w-[80%] mx-auto my-[1%]">
        <p className="text-5xl text-center text-[#000]">Privacy policy.</p>
        ...
        <div className="w-full items-start flex-col flex mt-[4%]">
          ...
          <p className="leading-6 text-1xl ">
            ...
            share that information. While you are not required to share any
            information with us, some information is necessary for using our
            services. This policy also explains when we share your personal
            information with third parties, such as our service providers and
            credit bureaus.
          </p>
          <p className="leading-6 text-1xl  mt-[2%]">
            These Terms also highlight certain risks on using our services and
            ...
            agreeing to be bound by them. You must not use any of the Services
          ...
          <p className="leading-6 text-1xl ">
            As part of our Know Your Customer (KYC) process, we run checks on
            the identity information you supply during signup. We will try to
            ...
            or through authorized service providers.
          </p>
          <p className="text-2xl my-[4%] ">How do we use your information?</p>
          <p className="leading-6 text-1xl ">
            The Nigerian Data Protection Regulations 2019 (NDPR) requires that
            we have a lawful basis for processing your personal information. At
            least one of the following lawful basis must apply before we process
            your personal information: contractual or legal obligations,
            legitimate interest of the data controller, public interest, vital
            interest of the data subject or consent.
          </p>

          <p className="text-2xl my-[4%] ">Contractual Obligation</p>
          <p className="leading-6 text-1xl ">
            We collect certain data from you to fulfill the contract we have
            with you, or to enter into a contract with you. We use this data to:
            <br />
            <br />
          ...
          <p className="text-2xl my-[4%] ">Legal Duty</p>
          <p className="leading-6 text-1xl ">
            We must ensure compliance with laws by preventing illegal activities
            such as money laundering, terrorism financing, and fraud. To achieve
            this, we need your data to:
          </p>
          <br />
          <ul className="list-disc list-inside pl-4">
            ...
            <li className="text-gray-800 text-lg mb-2">
              Maintain records of the information we hold about you in
          ...
          <p className="leading-6 text-1xl ">
            ...
            third parties that we do business with, like card producers and
            credit bureaus, or with law enforcement agencies when required.
            Sharing of confidential customer information with these related
            third parties would be done in a secure manner.
          </p>
          ...
          <p className="leading-6 text-1xl ">
            We are basically storing and processing your personal data only as
            long as it is necessary to perform our obligations under the
            agreement with you or as long as the law requires us to store it.
            <br />
          ...
          <p className="text-2xl my-[4%] ">What are your rights?</p>
          <p className="leading-6 text-1xl ">
            You are entitled to access and request the information we hold about
            you. You may also request that we delete your information, restrict
            how we use it, update or correct any inaccuracies, and we will
            comply with these requests as long as it is legally permissible.
            Additionally, you have the right to object to our use of your
            information for marketing purposes or any additional services we
            provide. Finally, you may withdraw any consent you have previously
            given us.
          </p>
          <p className="text-2xl my-[4%] ">12. Anti-Corruption</p>
          <p className="leading-6 text-1xl ">
            Each Party shall comply with all applicable anti-bribery and
            corruption Laws in Nigeria (including the Economic and Financial
            Crime Commission’s Act).
          </p>
          <p className="text-2xl my-[4%] ">Changes to This Document</p>
          <p className="leading-6 text-1xl ">
            This document will be reviewed annually or more frequently if
            prompted by changes or amendments to applicable data protection
            regulations.
          </p>
